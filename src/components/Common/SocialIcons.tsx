...
export const LinkedinIcon: React.FC<{ size?: number; style?: React.CSSProperties; className?: string }> = ({
  size = 14,
  style,
  className = '',
}) => (
...
export const GithubIcon: React.FC<{ size?: number; style?: React.CSSProperties; className?: string }> = ({
  size = 14,
  style,
  className = '',
}) => (
